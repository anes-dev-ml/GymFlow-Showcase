...
The `v1.0.0-showcase` release does not include a public walkthrough video,
thumbnail, captions file, or downloadable video asset.

The current release evidence is provided through the
